...
build-client:
	GOOS=windows go build -o ./bin/client_windows -ldflags="-X 'internal/cli/build_version/build_version.Version=v1.0.0'" ./cmd/client/main.go && \
	GOOS=darwin GOARCH=amd64 go build -o ./bin/client_mac -ldflags="-X 'internal/cli/build_version/build_version.Version=v1.0.0'"  ./cmd/client/main.go && \
	GOOS=linux GOARCH=ppc64 go build -o ./bin/client_linux -ldflags="-X 'internal/cli/build_version/build_version.Version=v1.0.0'" ./cmd/client/main.go
