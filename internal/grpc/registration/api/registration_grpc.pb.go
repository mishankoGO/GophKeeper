...
const (
	Credentials_Register_FullMethodName = "/api.Credentials/Register"
)
...
func (c *credentialsClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	out := new(RegisterResponse)
	err := c.cc.Invoke(ctx, Credentials_Register_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCredentialsServer) Register(context.Context, *RegisterRequest) (*RegisterResponse, error) {
...
var Credentials_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/registration.proto",
}
